...
<div class="nig_settings">
	...
	<?php if(isset($facebook_cpt_settings['app_id'])) $app_id = $facebook_cpt_settings['app_id']; else $app_id = "1869036243369971"; ?>
	<input class="input-width" id="app_id" name="app_id" type="text" value="<?php echo esc_attr($app_id); ?>" placeholder="Type Facebook Application ID"> ( <a href="https://awplife.com/create-facebook-application-id/" target="_new">Create New Own Facebook Application ID</a> )<br>
...
<div class="nig_settings">
	...
	<?php if(isset($facebook_cpt_settings['fb_page_url'])) $fb_page_url = $facebook_cpt_settings['fb_page_url']; else $fb_page_url = "https://www.facebook.com/AWordPressLife/"; ?>
	<input class="input-width" id="fb_page_url" name="fb_page_url" type="text" value="<?php echo esc_attr($fb_page_url); ?>" placeholder="Enter Facebook Application ID Here"><br>
	<h4><?php _e('You Should Type Your Facebook Page URL In This Setting Field ', FLB_TXTDM); ?></h4>
	<a class="be-right1 button button-primary" href="#">Go To Top</a>
</div>
...
<div class="nig_settings">
	...
	<p class=" switch-field em_size_field">
		<?php if(isset($facebook_cpt_settings['title'])) $title = $facebook_cpt_settings['title']; else $title = "false"; ?>
...
<div class="nig_settings">
	...
	<p class="range-slider">
		<?php if(isset($facebook_cpt_settings['w_width'])) $w_width = $facebook_cpt_settings['w_width']; else $w_width = "300"; ?>
		<input id="w_width" name="w_width" class="range-slider__range" type="range" value="<?php echo $w_width; ?>" min="180" max="500">
		<span class="range-slider__value">0</span>
		<h4><?php _e('You Can Set Your Custom Likebox Width In This Field By Using This Range Bar', FLB_TXTDM); ?></h4>
	</p>
	<a class="be-right1 button button-primary" href="#">Go To Top</a>
</div>
...
<div class="nig_settings">
	...
	<p class="range-slider">
		<?php if(isset($facebook_cpt_settings['w_height'])) $w_height = $facebook_cpt_settings['w_height']; else $w_height = "500"; ?>
		...
		<h4><?php _e('You Can Set Your Custom Likebox Height In This Field By Using This Range Bar', FLB_TXTDM); ?></h4>
	</p>
	<a class="be-right1 button button-primary" href="#">Go To Top</a>
</div>
...
<div class="nig_settings">
	...
	<h4><?php _e('Set Your facebook Cover Photo Setting By Using This Setting Field ', FLB_TXTDM); ?></h4>
	<a class="be-right1 button button-primary" href="#">Go To Top</a>
</div>
...
<div class="nig_settings">
	...
	<h4><?php _e('You Can Set Your facebook Likebox Widget Header Size By Using This Setting Field', FLB_TXTDM); ?></h4>
	<a class="be-right1 button button-primary" href="#">Go To Top</a>
</div>
...
<div class="nig_settings">
	...
	<h4><?php _e('You Can Show / Hide Your Facebook Friends Into Likebox By Using This Setting Field', FLB_TXTDM); ?></h4>
	<a class="be-right1 button button-primary" href="#">Go To Top</a>
</div>
...
<div class="nig_settings">
	...
	<h4><?php _e('You Can Show / Hide Your Posts & Pages Into Facebook Likebox By Using This Setting Field', FLB_TXTDM); ?></h4>
	<a class="be-right1 button button-primary" href="#">Go To Top</a>
</div>
...
<div class="nig_settings">
	<p class="bg-title"><?php _e('10. Show Plugin Credit Link', FLB_TXTDM); ?></p></br>
	<p class=" switch-field em_size_field">
		<?php if(isset($facebook_cpt_settings['credit_link'])) $credit_link = $facebook_cpt_settings['credit_link']; else $credit_link = "false"; ?>
		<input type="radio" name="credit_link" id="credit_link1" value="true" <?php if($credit_link == "true") echo "checked=checked"; ?>>
		<label for="credit_link1"><?php _e('Yes', FLB_TXTDM); ?></label>
		<input type="radio" name="credit_link" id="credit_link2" value="false" <?php if($credit_link == "false") echo "checked=checked"; ?>>
		<label for="credit_link2"><?php _e('No', FLB_TXTDM); ?></label><br>
	</p>
	<h4><?php _e('You Can Show / Hide Our Site Credit Link', FLB_TXTDM); ?></h4>
	<a class="be-right1 button button-primary" href="#">Go To Top</a>
</div>
